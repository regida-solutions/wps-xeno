...
function form_submit_button( string $button, array $form ): string {
	...
	return "<div class='wp-block-buttons'><div class='wp-block-button'><button class='wp-block-button__link' id='gform_submit_button_{$form['id']}'>{$form['button']['text']}</div></div>";
}
